...
var normalizeReference = inst.utils.normalizeReference;
...
function oembed_plugin(state, silent) {
    ...
    if (pos < max && state.src.charCodeAt(pos) === 0x28/* ( */) {
        ...
        if(!href.indexOf('oembed:') === 0) {
            return false;
        }

        href = href.substr('oembed:'.length, href.length);
