...
describe("Plugin:code block", () => {
    ...
    it("test leave code block on arrow down", (done) => {
        ...
        clickDropdownMenuItem('type','makeCodeBlock');
        pressKeyArrowDown();
        expect(toHtml()).to.equal('<div class="cm-editor cm-focused ͼ1 ͼ2 ͼ4" contenteditable="false"><div aria-live="polite" style="position: fixed; top: -10000px;"></div><div tabindex="-1" class="cm-scroller"><div spellcheck="false" autocorrect="off" autocapitalize="off" translate="no" contenteditable="true" class="cm-content" style="tab-size: 4" role="textbox" aria-multiline="true" data-language="javascript"><div class="cm-line">This is a code block</div></div><div class="cm-layer cm-layer-above cm-cursorLayer" aria-hidden="true" style="z-index: 150; animation-duration: 1200ms; animation-name: cm-blink;"></div><div class="cm-layer cm-selectionLayer" aria-hidden="true" style="z-index: -2;"></div></div></div><p><br class="ProseMirror-trailingBreak"></p>');
        done();
    });
});
